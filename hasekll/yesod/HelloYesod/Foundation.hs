...
mkMessage "HelloYesod" "messages" "en"
...
type Form x = Html -> MForm HelloYesod HelloYesod (FormResult x, Widget)
...
instance YesodPersist HelloYesod where
    type YesodPersistBackend HelloYesod = SqlPersist
    runDB f = do
        master <- getYesod
...
instance YesodNic HelloYesod

-- Sends off your mail. Requires sendmail in production!
deliver :: HelloYesod -> L.ByteString -> IO ()
#ifdef DEVELOPMENT
...
instance RenderMessage HelloYesod FormMessage where
